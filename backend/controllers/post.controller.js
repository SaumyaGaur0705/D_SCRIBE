...
export const deletePost = async (req,res)=>{
    ...
    try {
        ...
        //checked if logged in user is owner of post since they can only delete the post
        ...
        //remove postId from User table too

       const user= await User.findById(authodId);
       user.posts=user.posts.filter(id=>id.toString()!=postId);
       await user.save();

       user.bookmarks=user.bookmarks.filter(id=>id.toString()!=postId);
       //delete associated comments to the post
